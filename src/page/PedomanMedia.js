...
const PedomanMedia = () => {
  return (
    <div>
      <Header />
    <div className="pedoman-container">
      ...
      <ol className="alpha-list">
        ...
        <li>Setelah memuat berita sesuai dengan butir di atas, media wajib meneruskan upaya verifikasi, dan setelah verifikasi didapatkan, hasil verifikasi dicantumkan pada berita pemutakhiran (update) dengan tautan pada berita yang belum terverifikasi.</li>
      </ol>

      <h2>Isi Buatan Pengguna (User Generated Content)</h2>
      <ol className="alpha-list">
      ...
      <h2>Ralat, Koreksi, dan Hak Jawab</h2>
      <ol className="alpha-list">
    ...
    <ol className="alpha-list">
      ...
      <p style={{ marginBottom: '5px' }}>Bogor, 26 September 2024</p>
